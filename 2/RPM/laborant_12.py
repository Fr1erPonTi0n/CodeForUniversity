...
if __name__ == "__main__":
    ...
    measure_time(TestOne.original_count_words, 'text.txt')
    measure_time(TestOne.refactoring_count_words, 'text.txt')
    measure_time(TestOne.count_words_with_counter, 'text.txt')
